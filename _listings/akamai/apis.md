...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/properties/master/_listings/akamai/user-admin-v1-accounts-accountid-groups-groupid-properties-assetid-get.md
x-common:
- type: x-base
