...
- name: Akamai API Create or Update a Property
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/properties/master/_listings/akamai/config-gtm-v1-domains-domain-properties-propertyname-put.md
x-common:
- type: x-base
