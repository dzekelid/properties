...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/properties/master/_listings/akamai/user-admin-v1-accounts-accountid-properties-propertyid-post.md
x-common:
- type: x-base
