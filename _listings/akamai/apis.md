...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/properties/master/_listings/akamai/papi-v0-properties-propertyid-versions-latest-contractid,groupid,activatedon-get.md
x-common:
- type: x-base
