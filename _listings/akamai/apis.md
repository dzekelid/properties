...
- name: Akamai API Get a Rule Tree&#8217;s Digest
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/properties/master/_listings/akamai/papi-v0-properties-propertyid-versions-propertyversion-rules-head.md
x-common:
- type: x-base
